...
PRODUCT_COPY_FILES += \
    ...
    $(BLOB_PATH)/etc/wifi/plmn_se13.bin:system/etc/wifi/plmn_se13.bin \
    $(BLOB_PATH)/etc/wifi/srm.bin:system/etc/wifi/srm.bin \
    ...
    $(BLOB_PATH)/lib/hw/hwcomposer.exynos3.so:system/lib/hw/hwcomposer.exynos3.so \
    ...
    $(BLOB_PATH)/lib/libSamsungPostProcessConverter.so:system/lib/libSamsungPostProcessConverter.so \
